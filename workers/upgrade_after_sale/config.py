...
# 附件预解析并发线程数（飞书 API 限频 ~100 QPS，I/O 密集型，10 线程可安全达到 ~5-8 QPS）
ATTACHMENT_CONCURRENCY = 10
...
TARGET_STORE_STAT = LarkTargetConfig(
    ...
    field_mappings=[
        ...
        _fm("网格id", LarkFieldType.NUMBER),
        _fm("网格名称", LarkFieldType.TEXT),
        _fm("bd_id", LarkFieldType.NUMBER),
        _fm("bd姓名", LarkFieldType.TEXT),
        _fm("店铺id", LarkFieldType.NUMBER),
        _fm("最早下单日期", LarkFieldType.DATE),
        _fm("最近下单日期", LarkFieldType.DATE),
        _fm("最早下单间隔天数", LarkFieldType.NUMBER),
        _fm("最近下单间隔天数", LarkFieldType.NUMBER),
        ...
        _fm("近30天订单数量", LarkFieldType.NUMBER),
        _fm("近30天明细订单数量", LarkFieldType.NUMBER),
        ...
        _fm("近30天自然日撤销售后单数量", LarkFieldType.NUMBER),
        _fm("近30天自然日售后单数量", LarkFieldType.NUMBER),
        ...
        _fm("近7日升级售后自然日平台承担金额", LarkFieldType.NUMBER),
        _fm("近7日升级售后自然日单量", LarkFieldType.NUMBER),
        _fm("近7日总售后自然日单量", LarkFieldType.NUMBER),
        _fm("近30天下单天数", LarkFieldType.NUMBER),
        _fm("m13到m7下单天数", LarkFieldType.NUMBER),
        _fm("m29到m3升级售后天数", LarkFieldType.NUMBER),
        _fm("m29到m3升级售后且4日复购天数", LarkFieldType.NUMBER),
        _fm("近7天下单天数", LarkFieldType.NUMBER),
        _fm("近14天下单品类数", LarkFieldType.NUMBER),
        _fm("近14天下单水果品类数", LarkFieldType.NUMBER),
    ],
...
TARGET_MCT_CAT4_STAT = LarkTargetConfig(
    ...
    field_mappings=[
        ...
        _fm("近30天下单店铺数", LarkFieldType.NUMBER),
        _fm("近30天送达金额", LarkFieldType.NUMBER),
        _fm("近30天售后赔付金额", LarkFieldType.NUMBER),
        _fm("近30天品质问题售后赔付金额", LarkFieldType.NUMBER),
        _fm("近30天售后数量", LarkFieldType.NUMBER),
        _fm("近30天售后单数量", LarkFieldType.NUMBER),
        _fm("近7天下单店铺数", LarkFieldType.NUMBER),
        _fm("近7天送达金额", LarkFieldType.NUMBER),
        _fm("近7天售后赔付金额", LarkFieldType.NUMBER),
        _fm("近7天品质问题售后赔付金额", LarkFieldType.NUMBER),
        _fm("近7天售后数量", LarkFieldType.NUMBER),
...
TARGET_SKU_STAT = LarkTargetConfig(
    ...
    field_mappings=[
        ...
        _fm("送达金额", LarkFieldType.NUMBER),
        _fm("实付金额", LarkFieldType.NUMBER),
        _fm("明细订单数量", LarkFieldType.NUMBER),
        _fm("售后赔付金额", LarkFieldType.NUMBER),
        _fm("品质问题售后赔付金额", LarkFieldType.NUMBER),
        _fm("售后数量", LarkFieldType.NUMBER),
        _fm("售后单数量", LarkFieldType.NUMBER),
        ...
        _fm("近7天品质问题售后赔付金额", LarkFieldType.NUMBER),
        _fm("近7天售后单数量", LarkFieldType.NUMBER),
        _fm("近7天明细订单数量", LarkFieldType.NUMBER),
        _fm("前7天售后单数量", LarkFieldType.NUMBER),
        _fm("前7天明细订单数量", LarkFieldType.NUMBER),
        _fm("前7天售后明细单数量", LarkFieldType.NUMBER),
        _fm("前7天交易天数", LarkFieldType.NUMBER),
        _fm("m8到m5售后数量", LarkFieldType.NUMBER),
        _fm("m4到m1售后数量", LarkFieldType.NUMBER),
        _fm("m8到m5售后单数量", LarkFieldType.NUMBER),
        _fm("m4到m1售后单数量", LarkFieldType.NUMBER),
        _fm("m8到m5售后天数", LarkFieldType.NUMBER),
        _fm("m4到m1售后天数", LarkFieldType.NUMBER),
        _fm("m8到m5下单天数", LarkFieldType.NUMBER),
        _fm("m4到m1下单天数", LarkFieldType.NUMBER),
...
DATA_ROUTES: list[DataRoute] = [
    ...
    # 3.5 商家维度统计表（无附件）
    DataRoute(
        name="mct_stat_detail",
        target=TARGET_MCT_STAT,
        source_ref="mc:mct_stat",
        transforms=[],
        validation_level="warn",
    ),
    # 4. 门店维度表
