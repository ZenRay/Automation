...
,base AS(
    SELECT
        ...
        ,COUNT(DISTINCT IF(
            t2.dt BETWEEN DATEADD(DATE(t1.dt),  - 13, "dd") AND DATEADD(DATE(t1.dt),  - 7, "dd") AND t2.ordered_goods_num>0
            , t2.dt, NULL
        ...
        ,COUNT(DISTINCT IF(
            t2.dt BETWEEN DATEADD(DATE(t1.dt),  - 6, "dd") AND t1.dt AND t2.ordered_goods_num>0
            , t2.dt, NULL
