...
class TableItem:
    ...
    def add_field(self, field_name, field_type=None, field_desc=None):
        ...
        """
        field = Field(
            field_name=field_name, field_type=field_type, field_desc=field_desc
        )
    ...
    def from_dict(cls, data: dict):
        ...
        """
        table_item = cls(
            table_name=data.get("name"), table_desc=data.get("description")
        )
    ...
    def __str__(self):
        ...
        fields = ", ".join(
            [
                f"{f.field_name}(type:{f.field_type} desc:{f.field_desc})"
