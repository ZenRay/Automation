...
class LarkContactURL(Enum):
    ...
    SEARCH_USER_BY_PHONE_OR_EMAIL = (
        f"{_lark_host}/open-apis/contact/v3/users/batch_get_id"
    )
...
class APaaSURL(Enum):
    ...
    QUERY_WORKSPACE_TABLES = (
        f"{_lark_host}/open-apis/apaas/v1/workspaces/{{workspace_id}}/tables"
    )
